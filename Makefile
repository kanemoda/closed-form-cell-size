...
CORE_SRC := src/rng.c src/json.c src/config.c src/grid.c src/sim.c src/log.c src/scenarios.c src/oracle.c src/baselines.c
CORE_OBJ := $(CORE_SRC:.c=.o)

BINS := simulator test_grid_vs_bruteforce test_physics test_phase2 test_scenarios test_phase4
